...
## 5_sequencing
One notebook used to parse, format and print out details from the sequencing data from the chemostat evolution experiment. 

## 6_transporterKO
Notebooks used to analyze and plot the results from the transporter KO experiment.
